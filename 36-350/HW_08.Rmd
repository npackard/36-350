...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/npackard/36-350/main/README.md")
```
...
source_url("https://raw.githubusercontent.com/npackard/36-350/main/36-350/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/npackard/36-350/main/36-350/dark_and_stormy.R")
source_url("https://raw.githubusercontent.com/npackard/36-350/new_branch/36-350/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/npackard/36-350-Fork/main/check_mark.R")
```
---
...
expect_equal(f('a'), 0)
expect_equal(f('z'), log(26))
expect_error(f(1), "non-numeric argument")
expect_error(f("", ""), "unused argument")
expect_warning(f("ab"), "more than one character")
...
f = function(letter) {
  if (typeof(letter) != "character") stop("non-numeric argument")
  if (nchar(letter) > 1) warning("more than one character")
